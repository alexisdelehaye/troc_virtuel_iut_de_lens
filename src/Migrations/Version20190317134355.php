 ...
 */
final class Version20190317134355 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE objet CHANGE nomObjet nomObjet VARCHAR(65535) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE objet CHANGE nomObjet nomObjet VARCHAR(45) DEFAULT NULL COLLATE utf8mb4_unicode_ci');
    }
}
